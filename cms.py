...
def classprofile():#classprofile
    ...
    Button(cprofile,text='Refresh',command=update).place(x=830,y=11)
...
home=Tk()
home['bg'] = '#49A'
home.geometry('280x150')
home.title('Class-Mangement-System')
Label(home,text='---HOME PAGE---',font='Helvetica 12 bold',bg='#49A').grid(row=1,column=3)
Label(home,text='version 1.0',bg='#49A').grid(row=1,column=4)
